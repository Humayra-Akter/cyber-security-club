                ...
                <div>
                        ...
                        <div className='lg:flex p-10'>
                                <div class="card p-10 w-96 border-l-primary">
                                        ...
                                        <h1 className='text-green-900 font-bold text-xl pt-8 pb-12 text-center'>Cyber Bullying</h1>
                                ...
                                <div class="card p-10 w-96">
                                        ...
                                        <h1 className='text-green-900 font-bold text-xl pt-8 pb-12 text-center'>Data Thrifting</h1>
                                ...
                                <div class="card p-10 w-96">
                                        ...
                                        <h1 className='text-green-900 font-bold text-xl pt-8 pb-12 text-center'>Cyber Attacks</h1>
                                ...
                                <div class="card p-10 w-96">
                                        <figure><img src={imp4} alt="cyber issue" /></figure>
                                        <h1 className='text-green-900 font-bold text-xl pt-8 pb-12 text-center'>Phishing</h1>
